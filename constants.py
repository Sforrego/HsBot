...
########## PSQL DB #############
stats_col_names = ['rsn', 'overall', 'overall_xp', 'attack', 'attack_xp', 'defence', 'defence_xp', 'strength', 'strength_xp', 'hitpoints', 'hitpoints_xp', 'ranged', 'ranged_xp', 'praye', 'prayer_xp', 'magic', 'magic_xp', 'cooking', 'cooking_xp', 'woodcutting', 'woodcutting_xp', 'fletching', 'fletching_xp', 'fishing', 'fishing_xp', 'firemaking', 'firemaking_xp', 'crafting', 'crafting_xp', 'smithing', 'smithing_xp', 'mining', 'mining_xp', 'herblore', 'herblore_xp', 'agility', 'agility_xp', 'thieving', 'thieving_xp', 'slayer', 'slayer_xp', 'farming', 'farming_xp', 'runecraft', 'runecraft_xp', 'hunter', 'hunter_xp', 'construction', 'construction_xp', 'clues_total', 'beginner', 'easy', 'medium', 'hard', 'elite', 'master', 'abyssal_sire', 'alchemical_hydra', 'barrows_chests', 'bryophyta', 'callisto', 'cerberus', 'chambers_of_xeric', 'chambers_of_xeric:_challenge_mode', 'chaos_elemental', 'chaos_fanatic', 'commander_zilyana', 'corporeal_beast', 'crazy_archaeologist', 'dagannoth_prime', 'dagannoth_rex', 'dagannoth_supreme', 'deranged_archaeologist', 'general_graardor', 'giant_mole', 'grotesque_guardians', 'hespori', 'kalphite_queen', 'king_black_dragon', 'kraken', "kree'arra", "k'ril_tsutsaroth", 'mimic', 'nightmare', 'obor', 'sarachnis', 'scorpia', 'skotizo', 'the_gauntlet', 'the_corrupted_gauntlet', 'theatre_of_blood', 'thermonuclear_smoke_devil', 'tzkal-zuk', 'tztok-jad', 'venenatis', "vet'ion", 'vorkath', 'wintertodt', 'zalcano', 'zulrah', 'created_at', 'updated_at']
